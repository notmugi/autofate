...
/// <summary>
/// WrathCombo IPC wrapper following the official docs/IPCExample.cs pattern.
/// We register a lease (with a cancellation callback) and drive auto-rotation.
/// </summary>
public static class WrathComboIPC
{
    public const string InternalName = "WrathCombo";
    private const string CallbackPrefix = "AutoFatesWrathCallback";
    ...
    private static Guid? EnsureLease()
    {
        ...
        try
        {
            _lease = RegisterForLeaseWithCallback(InternalName /*our internal name*/, "AutoFates", CallbackPrefix);
            if (_lease == null)
...
public class WrathComboCallbackReceiver
{
    ...
    {
        try { EzIPC.Init(this, prefix: "AutoFatesWrathCallback"); }
